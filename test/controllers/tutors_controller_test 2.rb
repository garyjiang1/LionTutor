...
class TutorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tutor" do
    assert_difference("Tutor.count") do
      post tutors_url, params: { tutor: { bio: @tutor.bio, email: @tutor.email, first_name: @tutor.first_name, last_name: @tutor.last_name, phone: @tutor.phone } }
    end
  ...
  test "should update tutor" do
    patch tutor_url(@tutor), params: { tutor: { bio: @tutor.bio, email: @tutor.email, first_name: @tutor.first_name, last_name: @tutor.last_name, phone: @tutor.phone } }
